...
delete_hydroserver= function(){
  try{
    ...
    $.notify(
        {
            message: `We are having problems recognizing the actual group or groups to delete. WE ARE WORKING ON IT :)`
        },
        {
            type: "danger",
            allow_dismiss: true,
...
showVariables = function(){
   try{
     ...
     $.notify(
         {
             message: `We are having problems recognizing the actual group and servers. WE ARE WORKING ON IT :)`
         },
         {
             type: "danger",
             allow_dismiss: true,
